...
public class Config {
  ...
  public Class<?>[] getProxyInterfaces(Class<?> cls) {
    return getInterfaceDefaults(cls);
  }
  ...
  private void checkAddView(Class<? extends View> viewInterface,
    ...
    ImplUtils.checkNotViewOrViewInternal(defaults);
  ...
  private void checkAddExternal(Class<? extends View> viewInterface,
    ...
    ImplUtils.checkNotViewOrViewInternal(viewInterface);
    ImplUtils.checkNotViewOrViewInternal(defaults);
  ...
  private void checkAddImplementation(Class<?> iface, Class<?> implementation) {
    ImplUtils.checkNotViewOrViewInternal(iface);
