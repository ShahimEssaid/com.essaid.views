...
import com.essaid.views.flex.hold.MapFactory;
...
public class ToMap {
  ...
  //throws IntrospectionException, InvocationTargetException, IllegalAccessException
  {
    ...
    if (object instanceof View) {
      ...
      ViewState viewState = ((View) object)._internal()._getViewHandler().getState();
      for (String featureName : viewState.getFeatureNames().stream().sorted().toList()) {
        Object featureValue = viewState.getFeatureValue(featureName);
